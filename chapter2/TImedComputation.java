/**
 * This program performs some mathematical computations and displays the results.
 * It also displays the value of the constant Math.PI. It then reports the number
 * of seconds that the computer spent on this task.
 */
package chapter2;
